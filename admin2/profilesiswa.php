...
?>
	<div id="main-full">
		...
		session_start(); 
		$_SESSION['nis']="3330001";
		$_SESSION['username'] ="Pevita";
		?>
		<form method="post">
			<table width="90%">
				<col width="25%">
				...
				if (!$siswa) { //try catch error mysql query
					...
					while($col=mysql_fetch_array($siswa)){
						...
						<tr>
							<td style=" font-size: 24pt;color:#30BFC1;font-weight: bold;">Alamat</td>
							<td class="profile-line"><?php echo $col['alamat'] ?></td>
						</tr>
						<tr>
							<td style=" font-size: 24pt;color:#30BFC1;font-weight: bold;">Email</td>
					...
					?>
				<tr>
					<td colspan="2"><br><input style="float:right;" type="submit"  name="Edit" value="Edit" ></td>
				</tr>
			</table>
		</form>
