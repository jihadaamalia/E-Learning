...
<html>
<head>
	<title>Latihan Soal | Kelas 6</title>
</head>
<body>
	...
	<!--////////////////////////////////////////////////CONTENT///////////////////-->
		<div id="main"> 
			<a style="font-family: Patrick Hand; font-size: 36pt; color:#30BFC1; "> Latihan Kelas 6 </a>
				<p style="font-family: Patrick Hand; font-size: 24pt;"> Keseimbangan Ekosistem  </p>
			

			<div id="page-wrap">
				<form method="POST" action="#">
					<div id="tabs">
						<?php include ("soal-kelas-6.php");?>
